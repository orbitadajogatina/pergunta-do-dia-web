<script>
  import Sparkles from 'svelte-ionicons/Sparkles.svelte';
  import twemoji from "@twemoji/api";

  function stemoji (node, emoji) {
    twemoji.parse(node);
    return {
      update(emoji) {
